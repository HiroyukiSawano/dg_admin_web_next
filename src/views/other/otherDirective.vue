<template>
  <el-card shadow="never" header="高精度权限控制">
    ...
    <el-button v-auths-all="['USER.ADD', 'LIST.ADD']" type="primary">v-auths-all="['LIST.ADD','USER.ADD']"</el-button>
  ...
  <el-card shadow="never" header="用户角色权限控制" style="margin-top: 15px">
    <el-button v-role="'ROLE_SYSTEM'" type="primary">v-role="'ROLE_SYSTEM'"</el-button>
    <el-button v-role="['AUTH_SYSTEM_ADMIN', 'ROLE_SYSTEM']" type="primary">v-role="['AUTH_SYSTEM_ADMIN','ROLE_SYSTEM']"</el-button>
    <el-alert title="v-role指令 是$ROLE的语法糖, 原理是判断是否含有用户所在的角色别名" style="margin-top: 20px"></el-alert>
  </el-card>
  <el-card shadow="never" header="时间转换" style="margin-top: 15px">
    <p>
  ...
  <el-card shadow="never" header="一键复制" style="margin-top: 15px">
    <el-input v-model="copyText" type="textarea" :rows="2" placeholder="请输入内容"></el-input>
