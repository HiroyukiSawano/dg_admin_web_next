<template>
  <div
    class="el-layout el-layout--mixture"
...
defineOptions({ name: 'LayoutMixture' })
...
.el-layout.el-layout--mixture {
  ...
  >.el-container>.el-container>.el-splite,
...
[data-theme='primary'] {
  .el-layout.el-layout--mixture {
    ...
    >.el-container>.el-container>.el-splite {
      ...
      .el-menu {
        --el-menu-active-bg-color: var(--el-color-primary-light-3);
