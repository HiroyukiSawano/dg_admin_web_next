<template>
  <el-dialog v-model="visible" :title="titleMap[mode]" :width="560" destroy-on-close @closed="$emit('closed')">
    <el-form ref="dialogForm" :model="form" :rules="rules" :disabled="mode === 'show'" :label-width="64" label-position="right">
