  ...
  <el-card class="organization-page">
    <el-form :model="queryForm" inline @submit.prevent>
      ...
      <el-form-item :label="t('ec.organization.person.form.status')">
        <el-input v-model="queryForm.status" clearable :placeholder="t('ec.organization.person.form.statusPlaceholder')" />
      </el-form-item>
      <el-form-item>
  ...
  >
    <el-form ref="formRef" :model="formData" :rules="formRules" label-width="110px">
      ...
      <el-form-item :label="t('ec.organization.common.status')" prop="status">
        <el-input v-model="formData.status" clearable :placeholder="t('ec.organization.person.form.statusPlaceholder')" />
      </el-form-item>
    </el-form>
    <template #footer>
    ...
    <div v-loading="detailLoading" class="organization-detail" v-if="detailRecord">
      <div class="organization-detail__grid">
        ...
        <div class="organization-detail__item">
          ...
          <strong>{{ detailRecord.person?.status || '-' }}</strong>
        </div>
        <div class="organization-detail__item">
...
const formRules = {
  ...
  status: [{ required: true, message: t('ec.organization.person.validation.statusRequired'), trigger: 'blur' }],
}
